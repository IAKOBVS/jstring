...
#define JSTR_MAX_INT_DIGITS	  10
#define JSTR_MAX_LONG_DIGITS	  10
#define JSTR_MAX_LONG_LONG_DIGITS 19

#define JSTR_MIN_MMAP (128 * 1024)

#define JSTR_HAVE_ALLOCA 1

#define JSTR_MAX_UINT_DIGITS	   (JSTR_MAX_INT_DIGITS + 1)
#define JSTR_MAX_ULONG_DIGITS	   (JSTR_MAX_LONG_DIGITS + 1)
#define JSTR_MAX_ULONG_LONG_DIGITS (JSTR_MAX_LONG_LONG_DIGITS + 1)

#define JSTR_MIN_CAP 24

#define PRIV_JSTR_GROWTH_MULTIPLIER 1.5
...
#ifndef PRIV_JSTR_GROWTH_MULTIPLIER
#	define PRIV_JSTR_GROWTH_MULTIPLIER 2
#endif /* PRIV_JSTR_GROWTH_MULTIPLIER */
