...
#define PJSTR_ITOA(_max_digits, _base)                                         \
	do {                                                                   \
...
#define PJSTR_UITOA(_max_digits, _base)                       \
	do {                                                  \
		JSTR_ASSERT_IS_STR(_dst);                     \
		JSTR_ASSERT_IS_SIZE(_base);                   \
		JSTR_ASSERT_IS_SIZE(_max_digits);             \
...
#define PJSTR_UITOA_UNROLLED(_max_digits, _base)                                                                                                                                                                    \
	do {                                                                                                                                                                                                        \
		if (jstr_unlikely(_num <= 1)) {                                                                                                                                                                     \
			...
			if (sizeof(_num) == sizeof(long long)                                                                                                                                                       \
			    || _num <= 1000000000) {                                                                                                                                                                \
			...
			if (sizeof(_num) == sizeof(long long)) {                                                                                                                                                    \
				if (_num <= 10000000000) {                                                                                                                                                          \
					...
					_s[17] = _num % _base + '0';                                                                                                                                                \
					_s += 18;                                                                                                                                                                   \
				} else if (sizeof(_num) == sizeof(unsigned long long)) {                                                                                                                            \
...
PJSTR_DEFINE_ITOA(long long, jstr_lltoa, PJSTR_MAX_INT_DIGITS)
...
PJSTR_DEFINE_UITOA(unsigned long long, jstr_ulltoa, PJSTR_MAX_INT_DIGITS)
