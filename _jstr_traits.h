...
JSTR_INLINE static constexpr int jtraits_is_same_decay() JSTR_NOEXCEPT
{
	using namespace std;
...
template <typename T, typename Arg>
JSTR_INLINE static constexpr int jtraits_is_same_decay(Arg) JSTR_NOEXCEPT
{
	return jtraits_is_same_decay<T, Arg>();
}

template <typename Str>
JSTR_INLINE static constexpr int jtraits_are_strings() JSTR_NOEXCEPT
{
	using namespace std;
...
template <typename Str>
JSTR_INLINE static constexpr int jtraits_are_strings(Str) JSTR_NOEXCEPT
{
	return jtraits_are_strings<Str>();
}

template <typename Str, typename... StrArgs>
JSTR_INLINE static constexpr int jtraits_are_strings(Str, StrArgs...) JSTR_NOEXCEPT
{
	return jtraits_are_strings<Str, StrArgs...>();
}

template <typename Str, typename... StrArgs>
JSTR_INLINE static constexpr void jtraits_assert_jtraits_are_strings(Str &&, StrArgs &&...) JSTR_NOEXCEPT
{
	static_assert(jtraits_are_strings<Str, StrArgs...>(), "Passing non-strings as string arguments!");
}

template <typename T, typename Arg>
JSTR_INLINE static constexpr int jtraits_are_same() JSTR_NOEXCEPT
{
...
template <typename T, typename Arg>
JSTR_INLINE static constexpr int jtraits_are_same(Arg) JSTR_NOEXCEPT
{
	return jtraits_are_same<T, Arg>();
}

template <typename T, typename Arg, typename... Args>
JSTR_INLINE static constexpr int jtraits_are_same(Arg, Args...) JSTR_NOEXCEPT
{
	return jtraits_are_same<T, Arg, Args...>();
}

template <typename T, typename Arg, typename... Args>
JSTR_INLINE static constexpr void jtraits_assert_jtraits_are_same(Arg &&, Args &&...) JSTR_NOEXCEPT
{
