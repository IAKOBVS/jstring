...
JSTR_NONNULL_ALL
JSTR_WARN_UNUSED
static int jstr_tupper(const int c) JSTR_NOEXCEPT
{
	switch (c) {
		JSTR_CASE_LOWER
		return c - 'a' + 'A';
...
JSTR_INLINE
JSTR_NONNULL_ALL
static void jstr_tuppers(char *JSTR_RST s) JSTR_NOEXCEPT
{
	for (;; ++s) {
		switch (*s) {
			JSTR_CASE_LOWER
...
JSTR_NONNULL_ALL
JSTR_WARN_UNUSED
static int jstr_tlower(const int c) JSTR_NOEXCEPT
{
	switch (c) {
		JSTR_CASE_UPPER
		return c - 'A' + 'a';
...
JSTR_INLINE
JSTR_NONNULL_ALL
static void jstr_tlowers(char *JSTR_RST s) JSTR_NOEXCEPT
{
	for (;; ++s) {
		switch (*s) {
			JSTR_CASE_UPPER
