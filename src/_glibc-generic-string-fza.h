...
#ifndef PJSTR_PJSTR_STRING_FZA_H
#define PJSTR_PJSTR_STRING_FZA_H 1
...
jstr_word_find_zero_low(jstr_word_ty x)
{
	...
	jstr_word_ty lsb = jstr_word_repeat_bytes(0x01);
	jstr_word_ty msb = jstr_word_repeat_bytes(0x80);
	return (x - lsb) & ~x & msb;
}
