...
JSTR_FUNC_PURE
static jstr_ty *
jstr_l_find_case_len(const jstr_l_ty *R l,
		     const char *R s,
		     const size_t s_len)
JSTR_NOEXCEPT
{
	jstr_l_foreach (l, j)
		if (s_len == j->size
		    && !jstr_strcasecmp_len(s, j->data, s_len))
			return j;
	return NULL;
}
...
JSTR_FUNC_PURE
static jstr_ty *
jstr_l_find_strchr(const jstr_l_ty *R l,
		   const int c)
JSTR_NOEXCEPT
{
	jstr_l_foreach (l, j)
...
JSTR_FUNC_PURE
static jstr_ty *
jstr_l_find_strstr_len(const jstr_l_ty *R l,
		       const char *R s,
		       const size_t s_len)
JSTR_NOEXCEPT
{
...
JSTR_FUNC_PURE
static jstr_ty *
jstr_l_find_starts_len(const jstr_l_ty *R l,
		       const char *R s,
		       const size_t s_len)
JSTR_NOEXCEPT
{
...
JSTR_FUNC_PURE
static jstr_ty *
jstr_l_find_startscase_len(const jstr_l_ty *R l,
			   const char *R s,
			   const size_t s_len)
JSTR_NOEXCEPT
{
...
JSTR_FUNC_PURE
static jstr_ty *
jstr_l_find_ends_len(const jstr_l_ty *R l,
		     const char *R s,
		     const size_t s_len)
JSTR_NOEXCEPT
{
...
JSTR_FUNC_PURE
static jstr_ty *
jstr_l_find_endscase_len(const jstr_l_ty *R l,
			 const char *R s,
			 const size_t s_len)
JSTR_NOEXCEPT
{
...
JSTR_FUNC_VOID
static void
jstr_l_find_strchr_delete(jstr_l_ty *R l,
			  const int c)
JSTR_NOEXCEPT
{
	pjstr_l_delete(l, jstr_l_find_strchr(l, c));
}
...
JSTR_FUNC_VOID
static void
jstr_l_find_strstr_len_delete(jstr_l_ty *R l,
			      const char *R s,
			      const size_t s_len)
JSTR_NOEXCEPT
{
	pjstr_l_delete(l, jstr_l_find_strstr_len(l, s, s_len));
}
...
JSTR_FUNC_VOID
static void
jstr_l_find_starts_len_delete(jstr_l_ty *R l,
			      const char *R s,
			      const size_t s_len)
JSTR_NOEXCEPT
{
	pjstr_l_delete(l, jstr_l_find_starts_len(l, s, s_len));
}

JSTR_FUNC_VOID
static void
jstr_l_find_ends_len_delete(jstr_l_ty *R l,
			    const char *R s,
			    const size_t s_len)
JSTR_NOEXCEPT
{
	pjstr_l_delete(l, jstr_l_find_ends_len(l, s, s_len));
}

JSTR_FUNC_VOID
static void
jstr_l_find_case_len_delete(jstr_l_ty *R l,
			    const char *R s,
			    const size_t s_len)
JSTR_NOEXCEPT
{
	pjstr_l_delete(l, jstr_l_find_case_len(l, s, s_len));
}

JSTR_FUNC_VOID
static void
jstr_l_find_startscase_len_delete(jstr_l_ty *R l,
				  const char *R s,
				  const size_t s_len)
JSTR_NOEXCEPT
{
	pjstr_l_delete(l, jstr_l_find_startscase_len(l, s, s_len));
}

JSTR_FUNC_VOID
static void
jstr_l_find_endscase_len_delete(jstr_l_ty *R l,
				const char *R s,
				const size_t s_len)
JSTR_NOEXCEPT
{
	pjstr_l_delete(l, jstr_l_find_endscase_len(l, s, s_len));
}
