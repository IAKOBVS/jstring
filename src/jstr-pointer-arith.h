...
#define JSTR_ALIGN_UP_STR(base)                                                \
	JSTR_ALIGN_UP((uintptr_t)base, JSTR_MALLOC_ALIGNMENT)
#define JSTR_ALIGN_DOWN_STR(base)                                              \
	JSTR_ALIGN_DOWN((uintptr_t)base, JSTR_MALLOC_ALIGNMENT)
...
#define JSTR_PTR_IS_ALIGNED_STR(base)                                          \
	JSTR_PTR_IS_ALIGNED(base, JSTR_MALLOC_ALIGNMENT)
#define JSTR_PTR_NOT_CROSSING_PAGE(ptr, obj_size, page_size)                   \
	(JSTR_PTR_DIFF(JSTR_PTR_ALIGN_UP(ptr, page_size), ptr) >= obj_size)
