...
pjstr_find_zero_low (op_t x)
{
  ...
  op_t lsb = pjstr_repeat_bytes (0x01);
  op_t msb = pjstr_repeat_bytes (0x80);
  return (x - lsb) & ~x & msb;
}
...
static JSTR_INLINE pjstr_find_t
pjstr_find_zero_eq_low (op_t x1, op_t x2)
{
