...
JSTD_INLINE
JSTD_WARN_UNUSED
JSTD_CONST static std::size_t
JSTD_NEXT_POW2_32(T x)
{
	if
...
#define JSTD_CASE_VOWEL_LOWER \
case 'a':                     \
case 'i':                     \
case 'u':                     \
case 'e':                     \
case 'o':
#define JSTD_CASE_VOWEL_UPPER \
case 'A':                     \
case 'I':                     \
case 'U':                     \
case 'E':                     \
case 'O':
#define JSTD_CASE_VOWEL \
JSTD_CASE_VOWEL_UPPER:  \
	JSTD_CASE_VOWEL_LOWER

#define JSTD_CASE_CONSONANT_LOWER \
case 'b':                         \
case 'c':                         \
case 'd':                         \
case 'f':                         \
...
case 'y':                         \
case 'z':
#define JSTD_CASE_CONSONANT_UPPER \
case 'B':                         \
case 'C':                         \
case 'D':                         \
case 'F':                         \
...
case 'Y':                         \
case 'Z':
#define JSTD_CASE_CONSONANT \
JSTD_CASE_CONSONANT_UPPER:  \
	JSTD_CASE_CONSONANT_LOWER

#define JSTD_CASE_DIGIT \
case '0':               \
case '1':               \
case '2':               \
case '3':               \
