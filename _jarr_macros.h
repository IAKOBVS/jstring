...
#define PJARR_MIN_ALLOC(j, new_cap)	 PJARR_MIN_ALLOC_BASE(PJSTR_ALIGN_UP((new_cap)*PJARR_ELEMSZ(j)))
...
#define PJARR_REALLOC(j, new_cap, malloc_fail)                                                                    \
	do {                                                                                                      \
		PJSTR_GROW(PJARR_CAP(j), new_cap);                                                                \
		PJARR_CAP(j) *= PJARR_ELEMSZ(j);                                                                  \
		PJARR_CAP(j) = PJARR_ALIGN_UP(PJARR_CAP(j));                                                      \
